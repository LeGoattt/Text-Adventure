...
namespace TextAdventure
{
    ...
    internal class Programs
    {
        ...
        static void StartMenu()
        {
            ...
            else if (string.Compare(choice, "Bike Please", true) == 0)
            {
                bike();
            }
            else
        ...
        static void sleep3()
        {
            ...
            Thread.Sleep(500);
            lblal("stirring just moments later, you find yourself having sat down leaning against the wall.");
            Thread.Sleep(500);
        ...
        static void helloDerek() //GIVE ME MONEY
        {
            ...
            string choice = PromptPlayer();
            if (string.Compare(choice, "Bike Please", true) == 0)
            {
                bike();
            }
        ...
        static void bike()
        {
            Bike[] bikes =
            [
                new Bike() { Color = "Red", Type = "Mountain" },
                new Bike() { Color = "Blue", Type = "City" },
                

            ];

            Console.WriteLine("Gimme Color ");
            bikes[0].Color = Console.ReadLine();
